...
\begin{figure}[H]
\centering
\includegraphics[scale=0.23]{imagenes/DCU Registro de Usuario2.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.23]{imagenes/DCU Aplicar promociones a ordenes3.pdf}
\caption{Aplicar promociones a ordenes}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.23]{imagenes/Diagrama_requerimiento4 (1).pdf}
\caption{Facturación Instantanea}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.23]{imagenes/Caso de uso 5.pdf}
\caption{Historial de pedido}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.23]{imagenes/Requerimiento 6 (1).pdf}
\caption{Mostrar Recomendaciones Según Pedidos Anteriores}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.23]{imagenes/Requerimiento 7 (1).pdf}
\caption{Inicio de Sesión con Usuario y Contraseña}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.23]{imagenes/Diagrama_requerimiento8.pdf}
\caption{Tipo de servicio (Express o restaurante}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[scale=0.23]{imagenes/Requerimiento9.pdf}
