...
\item Ordenar
\item Registro cliente
\item Aceptar Promociones
\item Facturación instantánea
\item Mostrar historial de pedidos anteriores al cliente
\item Mostrar recomendaciones al cliente según sus pedidos anteriores
\item Inicio de sesión con usuario y contraseña tanto para clientes como para administradores
\item Tipo de servicio (Express o restaurante)
\item Distintos métodos de pago
\item Capacidad de habilitar la ubicación en tiempo real para mayor precisión en los pedidos express
\end{enumerate}
...
\item Mantenimiento a la aplicación
\item Encriptación de información sensible
\item Servidor para usuarios, pedidos y facturas
\item Flexibilidad para hacer cambios al programa
\item Multiplataforma (Windows, MacOS, Linux)
\item Capacidad para tener varios usuarios simultáneamente 		tanto para administradores como para clientes
\item Desarrollo de futuras versiones para sistemas operativos móviles
